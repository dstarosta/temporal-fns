 ...
 */
export type DateLike = Temporal.PlainDateTime | Temporal.PlainDate | Temporal.ZonedDateTime;
 ...
 * DST adjustment.
 */
export type TimeLike = Temporal.PlainDateTime | Temporal.ZonedDateTime;
