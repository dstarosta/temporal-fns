// Generated from Intl.supportedValuesOf('timeZone') (Node v26.3.1, ICU 78.3, tz 2026b). This is a
// snapshot, not a live query: the IANA tz database periodically adds, removes, or renames zones
// (e.g. when a country changes its DST rules or a region splits its zone), so this list can drift
// from what the runtime's Intl actually supports. Re-generate by running
// `Intl.supportedValuesOf('timeZone')` in the Node version you target and regenerating this file
// if that matters for your use case — `getTimezoneId()` and `Temporal.Now.timeZoneId()` are NOT
// restricted to this list and always reflect the real runtime environment.
