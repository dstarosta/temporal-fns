...
import { startOfYearValue } from './start-of-year.js';
 ...
 * // ]
 */
export function eachYearOfInterval<T extends DateLike>(
  interval: Interval<T>,
  options?: EachOfIntervalOptions
): T[];
export function eachYearOfInterval(
  ...
  return eachOfInterval(interval, options, startOfYearValue, addYears);
}
