 ...
 *
 * Untyped variant of {@link differenceInMinutes} that accepts the `Date | TimeLike` union directly,
 ...
 */
export const differenceInMinutesValue = createDifferenceInTimeUnitValue('minutes');
 ...
 * //=> -1
 */
export const differenceInMinutes = createDifferenceInTimeUnit('minutes');
